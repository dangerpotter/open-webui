...
from Falcor.apps.Falcor.models.tools import Tools
from Falcor.config import FUNCTIONS_DIR, TOOLS_DIR
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from Falcor.utils",
        "from apps": "from Falcor.apps",
        "from main": "from Falcor.main",
        "from config": "from Falcor.config",
    }
