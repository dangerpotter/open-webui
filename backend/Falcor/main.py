...
from Falcor.apps.retrieval.main import app as retrieval_app
from Falcor.apps.retrieval.utils import get_rag_context, rag_template

from Falcor.apps.socket.main import (
    app as socket_app,
...
from Falcor.utils.security_headers import SecurityHeadersMiddleware
...
from Falcor.utils.payload import convert_payload_openai_to_ollama
from Falcor.utils.response import (
...
async def update_embedding_function(request: Request, call_next):
    ...
    if "/embedding/update" in request.url.path:
        Falcor_app.state.EMBEDDING_FUNCTION = retrieval_app.state.EMBEDDING_FUNCTION
    return response
...
async def get_manifest_json():
    return {
        ...
        "description": "Falcor is an open, extensible, user-friendly interface for AI that adapts to your workflow.",
        "start_url": "/",
        "display": "standalone",
