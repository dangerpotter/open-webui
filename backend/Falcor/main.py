...
from Falcor.apps.audio.main import app as audio_app
from Falcor.apps.images.main import app as images_app
from Falcor.apps.ollama.main import app as ollama_app
from Falcor.apps.ollama.main import (
    generate_openai_chat_completion as generate_ollama_chat_completion,
)
from Falcor.apps.ollama.main import get_all_models as get_ollama_models
from Falcor.apps.openai.main import app as openai_app
from Falcor.apps.openai.main import (
    generate_chat_completion as generate_openai_chat_completion,
)
from Falcor.apps.openai.main import get_all_models as get_openai_models
from Falcor.apps.rag.main import app as rag_app
from Falcor.apps.rag.utils import get_rag_context, rag_template
from Falcor.apps.socket.main import app as socket_app
from Falcor.apps.socket.main import get_event_call, get_event_emitter
from Falcor.apps.Falcor.internal.db import Session
from Falcor.apps.Falcor.main import app as Falcor_app
from Falcor.apps.Falcor.main import (
    generate_function_chat_completion,
    get_pipe_models,
)
from Falcor.apps.Falcor.models.auths import Auths
from Falcor.apps.Falcor.models.functions import Functions
from Falcor.apps.Falcor.models.models import Models
from Falcor.apps.Falcor.models.users import UserModel, Users
from Falcor.apps.Falcor.utils import load_function_module_by_id
...
from Falcor.constants import ERROR_MESSAGES, TASKS, WEBHOOK_MESSAGES
from Falcor.env import (
    CHANGELOG,
    GLOBAL_LOG_LEVEL,
    SAFE_MODE,
    SRC_LOG_LEVELS,
...
from Falcor.utils.misc import (
    add_or_update_system_message,
    get_last_user_message,
    parse_duration,
    prepend_to_first_user_message_content,
)
from Falcor.utils.task import (
    moa_response_generation_template,
    search_query_generation_template,
    title_generation_template,
    tools_function_calling_generation_template,
)
from Falcor.utils.tools import get_tools
from Falcor.utils.utils import (
    create_token,
    decode_token,
    get_admin_user,
    get_current_user,
...
from Falcor.utils.webhook import post_webhook
...
{f"Commit: {Falcor_BUILD_HASH}" if Falcor_BUILD_HASH != "dev-build" else ""}
https://github.com/Falcor/Falcor
"""
)
