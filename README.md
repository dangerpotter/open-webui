# Falcor (Formerly Ollama Falcor) 👋

![GitHub stars](https://img.shields.io/github/stars/Falcor/Falcor?style=social)
![GitHub forks](https://img.shields.io/github/forks/Falcor/Falcor?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/Falcor/Falcor?style=social)
![GitHub repo size](https://img.shields.io/github/repo-size/Falcor/Falcor)
![GitHub language count](https://img.shields.io/github/languages/count/Falcor/Falcor)
![GitHub top language](https://img.shields.io/github/languages/top/Falcor/Falcor)
![GitHub last commit](https://img.shields.io/github/last-commit/Falcor/Falcor?color=red)
...
[![Discord](https://img.shields.io/badge/Discord-Open_Falcor-blue?logo=discord&logoColor=white)](https://discord.gg/5rJgQTnV4s)
...
- **If Ollama is on your computer**, use this command:
  ...
  ```bash
  docker run -d -p 3000:8080 --add-host=host.docker.internal:host-gateway -v Falcor:/app/backend/data --name Falcor --restart always ghcr.io/Falcor/Falcor:main
  ```
...
- **If Ollama is on a Different Server**, use this command:
  ...
  ```bash
  docker run -d -p 3000:8080 -e OLLAMA_BASE_URL=https://example.com -v Falcor:/app/backend/data --name Falcor --restart always ghcr.io/Falcor/Falcor:main
  ```

  - **To run Falcor with Nvidia GPU support**, use this command:

  ```bash
  docker run -d -p 3000:8080 --gpus all --add-host=host.docker.internal:host-gateway -v Falcor:/app/backend/data --name Falcor --restart always ghcr.io/Falcor/Falcor:cuda
  ```
...
- **If you're only using OpenAI API**, use this command:
  ...
  ```bash
  docker run -d -p 3000:8080 -e OPENAI_API_KEY=your_secret_key -v Falcor:/app/backend/data --name Falcor --restart always ghcr.io/Falcor/Falcor:main
  ```
...
- **With GPU Support**:
  ...
  ```bash
  docker run -d -p 3000:8080 --gpus=all -v ollama:/root/.ollama -v Falcor:/app/backend/data --name Falcor --restart always ghcr.io/Falcor/Falcor:ollama
  ```
...
- **For CPU Only**:
  ...
  ```bash
  docker run -d -p 3000:8080 -v ollama:/root/.ollama -v Falcor:/app/backend/data --name Falcor --restart always ghcr.io/Falcor/Falcor:ollama
  ```
...
```bash
docker run -d -p 3000:8080 -v Falcor:/app/backend/data --name Falcor --add-host=host.docker.internal:host-gateway --restart always ghcr.io/Falcor/Falcor:dev
```
...
<a href="https://star-history.com/#Falcor/Falcor&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Falcor/Falcor&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Falcor/Falcor&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Falcor/Falcor&type=Date" />
  </picture>
</a>

---

Modified from OpenWeb UI for Capella University by [Austin](https://github.com/dangerpotter) - Let's make Falcor even more amazing together! 💪
